...
- Single-case report labels/titles were cleaned after reviewing the latest plots: the default LAMSE checkpoint now labels as `LAMSE-0.1-LMAX32` instead of `LAMSE-0.1-5000`, and spectral plot titles now say `spectral diagnostics` rather than `AMSE-style spectral diagnostics`.
